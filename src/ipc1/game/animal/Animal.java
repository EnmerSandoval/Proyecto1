...
public abstract class Animal {
    ...
    // public enum Tipo {insecto, terrestre, acuatico, volador, mamifero, domestico,
    // solitario, desertico, reptil};
    ...
    */
    ...
    public void defense(Animal p1) {
        ...
        System.out.println("El ataque de: " + p1.getNombreAnimal() + " fue exitoso y " + this.getNombreAnimal()
                + " recibio daño y termino con  de vida");
